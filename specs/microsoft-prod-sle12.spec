...
Source0:	https://packages.microsoft.com/config/sles/12/prod.repo
...
%description
This package contains the zypper repo configuration 
...
install -Dpm 644 %{SOURCE0}  \
    $RPM_BUILD_ROOT%{_sysconfdir}/zypp/repos.d/microsoft-prod.repo
...
%files
%defattr(-,root,root,-)
%config(noreplace) /etc/zypp/repos.d/microsoft-prod.repo
